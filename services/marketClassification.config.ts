...
/**
 * Valid futures type values that can appear in the UI dropdown.
 * This is the canonical list - any futures type not in this list
 * will be filtered out of dropdown options.
 *
 * @constant {ReadonlyArray<string>}
 */
export const VALID_FUTURES_TYPES = [
  "NBA Championship",
  "Super Bowl",
  "World Series",
  "Stanley Cup",
