...
const totalHtmlPath = path.join(__dirname, '../fixtures/draftkings/rendered_total_stub.html');
...
const liveHtmlPath = path.join(__dirname, '../fixtures/draftkings/rendered_live_bet_stub.html');
